...
def do_homework(submit_url, classroom_id, course_sign, course_name):
    ...
    for homework in homework_ids:
        get_leaf_type_id_url = "https://zzugs.yuketang.cn/mooc-api/v1/lms/learn/leaf_info/"+str(classroom_id)+"/"+str(homework)+"/?term=latest&uv_id=2824"
        ...
        try:
            ...
            continue
        problem_url = "https://zzugs.yuketang.cn/mooc-api/v1/lms/exercise/get_exercise_list/"+str(leaf_id)+"/?term=latest&uv_id=2824"
