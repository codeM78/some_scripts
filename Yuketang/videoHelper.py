...
csrftoken = "7cYYfKFsY7LndTNEktksj2jF4GKyjGX9" #需改成自己的
sessionid = "khmjz94b94xz9lv3y0zcuhtfnj2uty63" #需改成自己的
...
def one_video_watcher(video_id,video_name,cid,user_id,classroomid,skuid):
    ...
    # https://zzugs.yuketang.cn/pro/courselist   #郑州大学研究生院网址 zzugs
    # university_id=2824
    url = "https://zzugs.yuketang.cn/video-log/heartbeat/"
    get_url = "https://zzugs.yuketang.cn/video-log/get_video_watch_progress/?cid="+str(cid)+"&user_id="+user_id+"&classroom_id="+classroomid+"&video_type=video&vtype=rate&video_id=" + str(video_id) + "&snapshot=1&term=latest&uv_id=2824"
...
def get_videos_ids(course_name,classroom_id,course_sign):
    get_homework_ids = "https://zzugs.yuketang.cn/mooc-api/v1/lms/learn/course/chapter?cid="+str(classroom_id)+"&term=latest&uv_id=2824&sign="+course_sign
...
if __name__ == "__main__":
    ...
    user_id_url = "https://zzugs.yuketang.cn/edu_admin/check_user_session/"
    ...
    # 然后要获取教室id
    get_classroom_id = "https://zzugs.yuketang.cn/mooc-api/v1/lms/user/user-courses/?status=1&page=1&no_page=1&term=latest&uv_id=2824"
    submit_url = "https://zzugs.yuketang.cn/mooc-api/v1/lms/exercise/problem_apply/?term=latest&uv_id=2824"
